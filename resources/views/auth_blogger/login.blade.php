...
<div class="limiter">
    <div class="container-login100">
        <div class="login100-more" style="background-image: url('images/loginBlog.jpg');"></div>
        ...
        <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
            <form class="form-horizontal" method="POST" action="{{ route('bloggers.login.submit') }}">
                ...
                <div class="container-login100-form-btn">
                    ...
                    <a href="{{ route('bloggers.register') }}" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
                        Créer un compte
