    ...
    <div class="container-login100">
        ...
        <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
            <form class="form-horizontal" method="POST" action="{{ route('partenaires.login.submit') }}">
                ...
                <div class="wrap-input100 validate-form validate-input {{ $errors->has('password') ? 'alert-validate' : '' }}" data-validate="{{ $errors->has('password') ? $errors->first('password') : 'le mot passe entré est incorrecte. Vous  l avez oublié ' }}">
