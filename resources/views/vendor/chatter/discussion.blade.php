                    ...
                    <div class="chatter_sidebar">
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            @foreach($categories as $category)
                                <li><a href="{{ url('/') . '/' . Config::get('chatter.routes.home') }}/{{ Config::get('chatter.routes.category') }}/{{ $category->slug }}">
...
<script>
	$('document').ready(function(){
		...
		$('.chatter_edit_btn').click(function(){
			...
			container.append('<div class="chatter_update_actions"><button class="btn btn-success pull-right update_chatter_edit"  data-id="' + id + '" data-markdown="' + markdown + '"><i class="chatter-check"></i> @lang('chatter::messages.response.update')</button><button href="{{ url('/') }}" class="btn btn-default pull-right cancel_chatter_edit" data-id="' + id + '"  data-markdown="' + markdown + '">@lang('chatter::messages.words.cancel')</button></div>');
