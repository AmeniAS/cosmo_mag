...
<html lang="en">
<head>
    <title>CosmoMag | Register - Admin</title>
    <meta charset="UTF-8">
...
<div class="limiter">
    <div class="container-login100">
        ...
        <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
            <form class="form-horizontal" method="POST" action="{{ route('admins.register.submit') }}">
                ...
                <div class="container-login100-form-btn">
                    ...
                    <a href="{{ route('admins.login') }}" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
                        Login
